 ...
 * 
 */
@WebServiceClient(name = "MyWebserviceService", targetNamespace = "http://ctrl/", wsdlLocation = "http://localhost:8080/Demo_SOAP/MyWebservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://ctrl/", "MyWebserviceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Demo_SOAP/MyWebservice?wsdl");
    ...
    public MyWebservice getMyWebservicePort() {
        return super.getPort(new QName("http://ctrl/", "MyWebservicePort"), MyWebservice.class);
    }
    ...
    public MyWebservice getMyWebservicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ctrl/", "MyWebservicePort"), MyWebservice.class, features);
    }
